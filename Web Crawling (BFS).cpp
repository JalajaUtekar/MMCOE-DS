//Problem Statement: Web Crawling - Breadth First Search (BFS):
//Application:Indexing web pages for search engines.
//Example: A web crawler uses BFS to visit web pages systematically, starting from a seed URL and exploring links level by level. Nodes represent web pages. Edges represent hyperlinks. 
